...
(function() {
  Crafty.c("TiledLevel", {
    makeTiles: function(ts, drawType) {
      var components, i, k, posx, posy, sMap, sName, tHeight, tName, tNum, tWidth, tsHeight, tsImage, tsProperties, tsWidth, v, xCount, yCount, _i, _ref, _ref1;
